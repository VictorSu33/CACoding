...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearCase(viewManagerModel, clearViewModel, (ClearUserDataAccessInterface) userDataAccessObject);
    ...
    private static ClearController createClearCase(ViewManagerModel viewManagerModel, ClearViewModel clearViewModel,
